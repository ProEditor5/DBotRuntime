module.exports = {
	...
	execute(message, args, Discord, theme){
        ...
        {name: "How do I use DBot?", value: "You can use this link to invite DBot to your server: https://bit.ly/2TQ6Wpw"},
        {name: "What are some features of DBot?", value: "DBot contains 8 commands, use -help to list them."},
        {name: "Is DBot safe?", value: "DBot's entire code is available using the following link: https://bit.ly/3yqneE2"},
